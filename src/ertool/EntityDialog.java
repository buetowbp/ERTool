...
public class EntityDialog extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ertool.ERToolApp.class).getContext().getResourceMap(EntityDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ertool.ERToolApp.class).getContext().getActionMap(EntityDialog.class, this);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(IsWeak)
                    .addComponent(EntityNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(31, 31, 31))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(IsWeak, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public void createNewEntity() {
        if (isValidInput(EntityNameField.getText())){
            ERToolView.createEntity(EntityNameField.getText(),this.IsWeak.isSelected());
            this.setVisible(false);
        }
        else{
            
            JOptionPane.showMessageDialog(rootPane, "Entity name cannot be blank. Please try again.");
